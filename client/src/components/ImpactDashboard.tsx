...
const ImpactDashboard = () => {
  ...
  return (
    <div className="w-full max-w-6xl mx-auto px-4 mt-3 mb-2" ref={containerRef}>
      ...
      >
        <span
          className={`px-3 py-1 rounded-full text-[10px] sm:text-xs font-semibold uppercase tracking-widest inline-block whitespace-normal break-words text-center ${
            theme === "dark"
      ...
      <motion.div
        className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 py-2.5 px-1.5 pb-3 sm:pb-0"
        ...
        {metrics.map((metric, index) => {
          ...
          return (
            <motion.div
              ...
              className={`p-4 rounded-2xl border transition-all duration-300 relative group overflow-hidden flex flex-col justify-between min-h-[175px] sm:min-h-[155px] shadow-lg w-full sm:w-auto ${
                theme === "dark"
