...
const HeroSection = () => {
  ...
  return (
    <section
      ...
      className="flex flex-col items-center justify-center min-h-screen w-full px-2 pt-24 pb-4 border-b-[1px] border-b-gray-800"
      ref={heroRef}
            ...
            <div className="flex items-center justify-start w-full md:w-6/12 pb-2 px-4 md:px-0 max-w-full overflow-hidden">
              <div className="items-start justify-center w-full md:min-h-[42vh] flex flex-col gap-2 max-w-full">
                ...
                >
                  ...
                  <motion.p
                    className="mb-3 md:text-left text-center text-sm sm:text-base leading-relaxed text-gray-500 break-words max-w-[92vw] md:max-w-none mx-auto md:mx-0"
                    variants={itemVariants}
                  >
