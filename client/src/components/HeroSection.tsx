...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="flex flex-col items-center justify-center h-full w-full px-2 border-b-[1px] pb-5"
      ref={heroRef}
    ...
    >
      ...
      <MouseFollowEffect>
        <div className="flex flex-col items-center justify-center h-full w-full px-2">
          ...
          <motion.div
            className=" flex flex-col md:flex-row font-titleFont w-full lg:w-11/12 xl:w-11/12 md:items-center justify-center"
