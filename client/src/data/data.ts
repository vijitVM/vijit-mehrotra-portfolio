    ...
    positions: [
      {
        ...
        details: [
         {
            domain: "Technology",
            text: "[Social Listening & Growth Intelligence:]] Built and scaled an agentic social listening platform to identify growth and competitive signals from Twitter data at scale, including funding announcements, hiring trends, product launches, research activity, partnerships, and market expansion indicators. The system processes social media data through a multi-stage, multi-agent pipeline including ingestion, semantic deduplication, entity extraction, classification, and signal generation, and evolved from a linear workflow to an agentic LangGraph-based architecture enabling stateful execution and improved control over multi-step reasoning. For signal classification, the DSPy-based framework was migrated from Mistral to open-source OpenAI models (gpt-oss-20b / gpt-oss-120b), while other agents continued to use Mistral for tool-calling and LLaMA for generation tasks. Integrated Nomic embeddings with PGVector (HNSW) for semantic deduplication and similarity search, resulting in a 23% reduction in redundant content and a 30% improvement in overall data quality, while combined architectural and model optimizations enabled scaling from 7,500 to 15,000 tweets/day, a 60% reduction in processing time, 20–25% more actionable growth signals, and an improvement in classification accuracy from ~80% to ~90% using DSPy (SIMBA). (Technologies: Python, LangGraph, DSPy (SIMBA Optimizer and COT Module), Open-source OpenAI models (gpt-oss-20b / gpt-oss-20b), Mistral, LLaMA, Nomic Embeddings, PGVector, HNSW, SQL, langfuse)"
          },
          {
            domain: "Automotive",
