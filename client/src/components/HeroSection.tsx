        ...
        <div className="container mx-auto px-4 relative z-10">
          ...
          >
            ...
            >
              ...
              <motion.p
                className="text-gray-300 mb-4 md:text-left text-center text-sm sm:text-base"
                variants={itemVariants}
              >
              ...
              >
                ...
                >
                  <Button
                    ...
                    onClick={() => {
                      window.open(
                        "https://drive.google.com/file/d/1IMiq-HuDSRrnlhUMLmpcjEtVg8HRfhIX/view?usp=sharing",
                        "_blank",
                        "noopener,noreferrer",
                      );
                    }}
