...
const HeroSection = () => {
  ...
  return (
    <section
      id="home"
      className="flex flex-col items-center justify-center min-h-[90vh] w-full py-4 md:py-8 overflow-hidden relative"
      ref={heroRef}
    ...
    >
      ...
      <MouseFollowEffect>
        <div className="flex flex-col md:flex-row font-titleFont w-full lg:w-11/12 xl:w-11/12 md:items-center justify-center md:gap-8">
